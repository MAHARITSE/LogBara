...
-- Personnel (mots de passe en clair pour démo, hasher en production)
INSERT INTO personnel (nom, prenom, login, mot_de_passe, role, actif) VALUES
('Admin', 'Super', 'admin', 'admin123', 'Administrateur', TRUE),
('Gérant', 'Principal', 'gerant', 'gerant123', 'Gérant', TRUE),
('Caisse', 'Jean', 'caisse1', '1234', 'Caissier', TRUE),
('Caisse', 'Marie', 'caisse2', '1234', 'Caissier', TRUE),
('Magasin', 'Paul', 'magasin', '1234', 'Magasinier', TRUE),
('Serveur', 'Luc', 'serveur', '1234', 'Serveur', TRUE);
